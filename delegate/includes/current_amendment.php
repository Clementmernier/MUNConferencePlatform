<?php
// Get the current amendment under discussion for this committee
$currentAmendmentStmt = $pdo->prepare("
    ...
    LIMIT 1
");
$currentAmendmentStmt->execute([$delegate['committee_id']]);
    ...
    <div class="card-body">
        ...
        <?php else: ?>
            <div class="text-center text-muted py-3">
                ...
                <p class="mb-0">No amendment is currently under discussion.</p>
            </div>
        <?php endif; ?>
    </div>
</div>
